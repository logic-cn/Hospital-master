...
<body>
	<table width="100%" border="0" cellpadding="0" cellspacing="0" >
		...
		<tr>
			...
			<td class="main_locbg font2"><i class="layui-icon layui-icon-location" style="font-size: inherit;"></i>当前位置：用户管理
				&gt; 添加用户</td>
			<td width="15" height="32"><img
					...
					<table width="100%" border="0" cellpadding="0" cellspacing="10"
								...
								<table>
									<tr>
										<td class="font3 fftd">姓&nbsp;名：<input type="text"
											name="username" id="username" size="20" /></td>
										<td class="font3 fftd">状&nbsp;态：<input type="text"
											name="status" id="status" size="20" /></td>
									</tr>

									<tr>
										<td class="font3 fftd">登录名：<input name="loginname"
											id="loginname" size="20" /></td>
						...
						<tr>
							<td align="left" class="fftd"><input type="submit"
								value="添加" class="layui-btn layui-btn-xs">&nbsp;&nbsp;<input type="reset" value="取消 " class="layui-btn layui-btn-xs" onclick="javascript:window.history.back();return false;" 
								></td>
						</tr>
					</table>
				</form>
