...
<body>
	<table width="100%" border="0" cellpadding="0" cellspacing="0">
		...
		<tr>
			...
			<td class="main_locbg font2"><i class="layui-icon layui-icon-location" style="font-size: inherit;"></i>当前位置：职位管理
				&gt; 修改职位</td>
			<td width="15" height="32"><img
			...
			<td>
				<form action="${ctx}/job/updateJob" id="jobForm" method="post">
					...
					<input type="hidden" name="flag" value="2"> <input
						type="hidden" name="id" value="${job.id }">
								...
								<table>
									<tr>
										<td class="font3 fftd">部门名称：<input type="text"
											name="name" id="name" size="20" value="${job.name }" /></td>
										<td class="font3 fftd">详细描述：<input type="text"
											name="remark" id="remark" size="20" value="${job.remark }" /></td>
									</tr>
