					...
					<c:forEach items="${requestScope.jobs}" var="job" varStatus="stat">
						<tr id="data_${stat.index}" align="center" class="main_trbg"
							...
							<td align="center" width="40px;"><a
								href="${ctx}/job/updateJob?flag=1&id=${job.id}"><i class="layui-icon layui-icon-edit" style="font-size: inherit;color:#FF5722;">修改</i></a></td>
						</tr>
					</c:forEach>
				</table>
			</td>
