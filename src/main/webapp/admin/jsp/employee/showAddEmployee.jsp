			...
			<td>
				<form action="${ctx}/employee/addEmployee" id="employeeForm"
					...
					<table width="100%" border="0" cellpadding="0" cellspacing="10"
								...
								<table>
									<tr>
										...
										<td class="font3 fftd">身份证号码：<input type="text"
											name="cardId" id="cardId" size="20" /></td>
									</tr>
									<tr>
						...
						<tr>
							<td class="font3 fftd">QQ&nbsp;&nbsp;号码：<input name="qqNum"
								id="qqNum" size="20" />
							</td>
						</tr>
						<tr>
						...
						<tr>
							<td align="left" class="fftd"><input type="submit"
								value="添加">&nbsp;&nbsp;<input type="reset" value="取消 " onclick="javascript:window.history.back();return false;" 
								></td>
						</tr>
					</table>
				</form>
