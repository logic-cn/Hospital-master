	...
	<div style="margin: 10px; background-color: #FFFFFF; text-align: left;">
		<table width="200" height="100%" border="0" cellpadding="0"
			...
			<tr>
				...
				<div class="left_margin"><i class="layui-icon layui-icon-username">用户管理</i></div></td>
			</tr>
			<tr valign="top">
				<td height="50">
					<p class="left_nav_link">
						<a href="user/showUser" target="main">
						<i class="layui-icon layui-icon-triangle-r">用户查询</i></a>
					</p>
					<p class="left_nav_link">
						<a href="user/addUser?flag=1" target="main">
						<i class="layui-icon layui-icon-add-1">添加用户</i></a>
					</p>
				</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<div class="left_margin"><i class="layui-icon layui-icon-app">部门管理</i></div></td>
			</tr>
			<tr valign="top" id="submenu1" style="display: none">
				<td class="left_nav_bgshw" height="50">
					<p class="left_nav_link">
					<a href="dept/selectDept" target="main">
					<i class="layui-icon layui-icon-triangle-r">部门查询</i></a>
					</p>
					<p class="left_nav_link">
						<a href="dept/addDept?flag=1" target="main">
						<i class="layui-icon layui-icon-add-1">添加部门</i></a>
					</p>
				</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<div class="left_margin"><i class="layui-icon layui-icon-group">员工管理</i></div></td>
			</tr>
			<tr valign="top" id="submenu3" style="display: none">
				<td class="left_nav_bgshw" height="50">
					<p class="left_nav_link">
					<a href="employee/selectEmployee" target="main">
					<i class="layui-icon layui-icon-triangle-r">员工查询</i></a>
					</p>
					<p class="left_nav_link">
						<a href="employee/addEmployee?flag=1" target="main">
						<i class="layui-icon layui-icon-add-1">添加员工</i></a>
					</p>
				</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<div class="left_margin"><i class="layui-icon layui-icon-speaker">公告管理</i></div></td>
			</tr>
			<tr valign="top" id="submenu4" style="display: none">
				<td class="left_nav_bgshw tdbtmline" height="50">
					...
					<i class="layui-icon layui-icon-triangle-r">公告查询</i></a>
					</p>
					<p class="left_nav_link">
						<a href="notice/addNotice?flag=1" target="main">
						<i class="layui-icon layui-icon-add-1">添加公告</i></a>
					</p>
				</td>
			</tr>
			<tr>
