					...
					<tr>
						<td class="fftd">
							<form name="deptform" method="post" id="deptform"
								action="${ctx}/dept/selectDept">
								<table width="100%" border="0" cellpadding="0" cellspacing="0">
									<tr>
										<td class="font3">部门名称：<input type="text" name="name">
											<input type="submit" value="搜索" class="layui-btn layui-btn-xs"/> <input id="delete"
											type="button" value="删除" class="layui-btn layui-btn-xs layui-btn-danger" />
										</td>
									</tr>
								</table>
							</form>
					...
					<c:forEach items="${requestScope.depts}" var="dept"
						...
						<tr id="data_${stat.index}" align="center" class="main_trbg"
							...
							<td align="center" width="40px;"><a
								href="${ctx}/dept/updateDept?flag=1&id=${dept.id}"> <i class="layui-icon layui-icon-edit" style="font-size: inherit;color:#FF5722;">修改</i></a></td>
						</tr>
					</c:forEach>
				</table>
			</td>
