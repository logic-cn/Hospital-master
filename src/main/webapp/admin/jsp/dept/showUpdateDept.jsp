...
<body>
	<table width="100%" border="0" cellpadding="0" cellspacing="0">
		...
		<tr>
			...
			<td class="main_locbg font2"><i class="layui-icon layui-icon-location" style="font-size: inherit;"></i>当前位置：部门管理
				&gt; 修改部门</td>
			<td width="15" height="32"><img
			...
			<td>
				<form action="${ctx}/dept/updateDept" id="deptForm" method="post">
					...
					<input type="hidden" name="flag" value="2"> <input
						type="hidden" name="id" value="${dept.id }">
					<table width="100%" border="0" cellpadding="0" cellspacing="10"
						...
						<tr>
							<td class="font3 fftd">
								<table>
									<tr>
										<td class="font3 fftd">部门名称：<input type="text"
											name="name" id="name" size="20" value="${dept.name }" /></td>
										<td class="font3 fftd">详细描述：<input type="text"
											name="remark" id="remark" size="20" value="${dept.remark }" /></td>
									</tr>
						...
						<tr>
							<td align="left" class="fftd"><input type="submit"
								value="修改" class="layui-btn layui-btn-xs">&nbsp;&nbsp;<input type="reset" value="取消 " class="layui-btn layui-btn-xs" onclick="javascript:window.history.back();return false;" 
								></td>
						</tr>
					</table>
				</form>
